...
namespace CarShop.Test
{
    public class EmployeeTests
    {
        ...
        {
            {new Employee() {Id = 1, Name = "Kolio", Competence = Models.Enums.EmployeeCompetence.Engines, Salary = 1600}},
            {new() {Id = 2, Name = "Petio", Competence = Models.Enums.EmployeeCompetence.Gearboxes, Salary = 1400}}
        };
